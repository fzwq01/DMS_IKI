<template>
    <div id="container">
            ...
            <div class="item" v-if="keyIndex <= 3">
                <div class="formArea">
                    <div class="UKeyState">
                        ...
                        <div class="UKeyText" v-if="!USB">请插入UKey</div>
        ...
        <div class="btnContainerArea" v-if="keyIndex > 3">
            <button class="defaultBtn cancelBtn" @click="cancel">取 消</button>
            <button class="lightBlueBtn" @click="install">安 装</button>
        </div>
    ...
    methods: {
        ...
        install() {
            ...
            const timer = setTimeout( () => {
                this.$router.push({name:'deviceKeyProduction'});
            } , 1200 )
